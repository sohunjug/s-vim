...
let g:python3_host_prog='/usr/local/var/pyenv/versions/3.7.8/bin/python3'
"
" 插件配置文件所在路径
...
" 编辑vimrc
nnoremap <Leader>fve <esc>:e $MYVIMRC<CR>
" 重载vimrc
nnoremap <Leader>fvr <esc>:source $MYVIMRC<CR>
" 定义载入配置命令
